...
private:
	struct C_InstanceData
	{
		...
		{
			return sizeof(C_Entity) + sizeof(float) + sizeof(Vec2);
		}
	};
public:
	// Instance Handle
...
public:
	...
	static C_Instance MakeInstance(U32 index) { C_Instance instance = { index }; return instance; }
	...
	U32 GetNoInstances() const { return m_Data.m_NoElements; }
	Vec2 GetPos(C_Instance instance) const { return m_Data.m_Pos[instance.m_Index]; }
	void SetPos(C_Instance instance, Vec2 value) { m_Data.m_Pos[instance.m_Index] = value; }
	F32 GetGravity(C_Instance instance) const { return m_Data.m_Gravity[instance.m_Index]; }
	void SetGravity(C_Instance instance, F32 value) { m_Data.m_Gravity[instance.m_Index] = value; }
